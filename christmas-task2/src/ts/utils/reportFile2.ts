export const reportText2 = [
  "Здравствуй, проверяющий!",
  "",
  "1. Вёрстка страниц приложения и навигация между ними +20/30",
  ...
  " - на странице с ёлкой есть меню с настройками, слоты с добавленными в избранное игрушками, ёлка. Выполняются требования к вёрстке +5/10",
  " - в header приложения есть навигация, которая позволяет с каждой страницы приложения перейти на две другие страницы +5/10",
  ...
  " - выбранные настройки сохраняются в local storage +0/10",
  "3. Гирлянда +35/40",
  ...
  "У пользователя есть возможность:",
  " - вдобавить на ёлку мерцающую разноцветную гирлянду +20/20",
  " - ввыбрать один из нескольких (минимум 4) цветов лампочек гирлянды или оставить её разноцветной +10/10",
  " - внешний вид гирлянды соответствует предложенному образцу или является его улучшенной версией +5/10",
  ...
  " - когда игрушку вешают на ёлку, количество игрушек в слоте уменьшается, когда игрушку снимают с ёлки, - увеличивается, когда все экземпляры игрушки помещаются на ёлку, отображается пустой слот +10/10",
  "5. Дополнительный функционал на выбор +0/20",
  "ИТОГО: 155/220 баллов"
]